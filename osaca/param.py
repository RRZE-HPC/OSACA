...
class Register(Parameter):
    ...
    'DIL': (8, 'GPR'), 'SPL': (8, 'GPR'), 'R8L': (8, 'GPR'), 'R9L': (8, 'GPR'), 'R10L': (8, 'GPR'),
    'R11L': (8, 'GPR'), 'R12L': (8, 'GPR'), 'R13L': (8, 'GPR'), 'R14L': (8, 'GPR'),
    'R15L': (8, 'GPR'), 'R8B': (8, 'GPR'), 'R9B': (8, 'GPR'), 'R10B': (8, 'GPR'),
    'R11B': (8, 'GPR'), 'R12B': (8, 'GPR'), 'R13B': (8, 'GPR'), 'R14B': (8, 'GPR'),
    'R15B': (8, 'GPR'), 'AX': (16, 'GPR'), 'BC': (16, 'GPR'), 'CX': (16, 'GPR'), 'DX': (16, 'GPR'),
    'BP': (16, 'GPR'), 'SI': (16, 'GPR'), 'DI': (16, 'GPR'), 'SP': (16, 'GPR'), 'R8W': (16, 'GPR'),
    'R9W': (16, 'GPR'), 'R10W': (16, 'GPR'), 'R11W': (16, 'GPR'), 'R12W': (16, 'GPR'),
    'R13W': (16, 'GPR'), 'R14W': (16, 'GPR'), 'R15W': (16, 'GPR'), 'EAX': (32, 'GPR'),
    'EBX': (32, 'GPR'), 'ECX': (32, 'GPR'), 'EDX': (32, 'GPR'), 'EBP': (32, 'GPR'),
    'ESI': (32, 'GPR'), 'EDI': (32, 'GPR'), 'ESP': (32, 'GPR'), 'R8D': (32, 'GPR'),
    'R9D': (32, 'GPR'), 'R10D': (32, 'GPR'), 'R11D': (32, 'GPR'), 'R12D': (32, 'GPR'),
    'R13D': (32, 'GPR'), 'R14D': (32, 'GPR'), 'R15D': (32, 'GPR'), 'RAX': (64, 'GPR'),
    'RBX': (64, 'GPR'), 'RCX': (64, 'GPR'), 'RDX': (64, 'GPR'), 'RBP': (64, 'GPR'),
    'RSI': (64, 'GPR'), 'RDI': (64, 'GPR'), 'RSP': (64, 'GPR'), 'R8': (64, 'GPR'),
    'R9': (64, 'GPR'), 'R10': (64, 'GPR'), 'R11': (64, 'GPR'), 'R12': (64, 'GPR'),
    'R13': (64, 'GPR'), 'R14': (64, 'GPR'), 'R15': (64, 'GPR'), 'CS': (16, 'GPR'),
    'DS': (16, 'GPR'), 'SS': (16, 'GPR'), 'ES': (16, 'GPR'), 'FS': (16, 'GPR'), 'GS': (16, 'GPR'),
